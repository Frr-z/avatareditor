    ...
    return Promise.new(function(Resolve, Reject)
        ...
        elseif Sucess and Response then
            for _, Item in ipairs(Response.data) do 
                if Loaded[Id][Item.assetType] ~= nil then
                    table.insert(Loaded[Id][Item.assetType], Item)
                end
            end
        end
